        ...
        <div class="row">
            ...
            <div class="col-xs-6 col-lg-6 col-sm-6 col-md-6 col-6">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" name="agent_name" placeholder="Maquimbo Mcoy...">
                </div>
            </div>
            ...
            <div class="col-xs-3 col-lg-3 col-md-3 col-sm-3 col-3">
                <label>Origin</label>
                <div class="form-group">
                    <input type="text" class="form-control" name="origin" id="origin" placeholder="Fighter...">
                </div>
            </div>
            ...
            <div class="col-xs-6 col-lg-6 col-md-6 col-sm-6 col-6">
                <div class="row">
                    <div class="col-lg-2 col-md-2 col-2 col-sm-2">
                        ...
                        <div class="form-group">
                            <input name="lp" type="text" id="life" class="form-control">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-2 col-sm-2">
                    ...
                    <div class="col-lg-2 col-md-2 col-2 col-sm-2">
                        ...
                        <div class="form-group">
                            <input name="sp" type="text" id="san" class="form-control">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-2 col-sm-2">
                        <div class="form-group" style="margin-top: 20px;">
                    ...
                    <div class="col-lg-2 col-md-2 col-2 col-sm-2">
                        ...
                        <div>
                            <input name="ep" type="text" id="effort" class="form-control">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-2 col-sm-2">
                        <div class="form-group" style="margin-top: 20px;">
                    ...
                    <div class="col-lg-6 col-md-6 col-6 col-sm-6">
                        ...
                        <div class="form-group">
                            <input name="mov_meters" value="9m" type="text" class="form-control" placeholder="9m">
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-3 col-sm-3">
                        <label>Base Defense</label>
                        <div class="form-group">
                            <input name="defense" id="baseDef" onclick="baseDefense()" type="text" class="form-control">
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-3 col-sm-3">
                        <div class="form-group" style="margin-top: 20px;">
                    ...
                    <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                        ...
                        <div class="form-group">
                            <textarea name="proficiencies" id="prof" class="form-control" cols="30" rows="4"></textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xs-4 col-lg-4 col-md-4 col-sm-4 col-4 padFix">
                ...
                <div class="form-controll">
                    <input type="text" class="form-control" name="resistances">
                </div>
            </div>
